      ...
      <Card title="Company Profile" variant="borderless">
        <Form form={form} layout="vertical" onFinish={onFinish} autoComplete="off">
          ...
          <Form.Item
            name="phone"
            label="Phone"
            rules={[{ pattern: /^[0-9-+() ]*$/, message: 'Invalid phone format' }]}
          >
            <Input placeholder="Enter phone number" size="large" />
          </Form.Item>

          <Form.Item name="address" label="Address">
            <Input.TextArea placeholder="Enter company address" rows={3} size="large" />
          </Form.Item>
          ...
          <Form.Item name="username" label="Username" tooltip="Username cannot be changed">
